# TODO List for Discord Bot Implementation

- [x] Create package.json with dependencies (discord.js, dotenv)
- [x] Create index.js with bot logic, commands, permissions, and logging
